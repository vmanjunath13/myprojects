...
public class InventoryReport extends HttpServlet {
	...
	protected void displayLogin(HttpServletRequest request,
		...
		pw.print("<a style='font-size: 32px;'>List of all Products</a>");
		...
		try
		{
			...
			pw.print("<td style='text-align:center;'><strong>Count</strong></td></tr>");
			...
			for (Map.Entry<String,Product> entry : pMap.entrySet()) 
			{
				...
				pw.print("<td style='font-size:14px; text-align:center;'>"+product.getcount()+"</td>");
				pw.print("</tr>");
