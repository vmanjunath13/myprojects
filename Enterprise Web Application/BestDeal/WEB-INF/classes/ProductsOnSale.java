...
public class ProductsOnSale extends HttpServlet {
	...
	protected void displayLogin(HttpServletRequest request,
		...
		pw.print("<a style='font-size: 32px;'>Products On Sale</a>");
		pw.print("</h2><div class='entry'>");

		try
		{
			Map<String,Product> pMap = MySqlDataStoreUtilities.getProductsOnSale();
			...
			pw.print("<td style='text-align:center;'><strong>Price</strong></td></tr>");
