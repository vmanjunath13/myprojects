...
public class SalesReport extends HttpServlet {
	...
	protected void displayLogin(HttpServletRequest request,
		...
		pw.print("<a style='font-size: 32px;'>Product List with Sold Quantity</a>");
		...
		try
		{
			...
			pw.print("<td style='text-align:center;'><strong>Count</strong></td>");
			pw.print("<td style='text-align:center;'><strong>Total Sales</strong></td></tr>");
			...
			for (Map.Entry<String,Product> entry : pMap.entrySet()) 
			{
				...
				pw.print("<td style='font-size:14px; text-align:center;'>"+product.getnum_items()+"</td>");
