	...
	protected void review(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        {           
			...
			{	
				...
				{
					int count = 0;
					System.out.println(hm.get(PName));
					for (Review r : hm.get(PName)) 
				 	{	
				 		...
				 		if(count == 0){
							...
							pw.print("<p style='color:#333333; padding-top:20px; font-size:16px; margin-bottom:3px; line-height:0.5em;'><strong>Product Category:</strong>"+"&nbsp&nbsp&nbsp&nbsp&nbsp<strong>"+r.getPCategory()+"</strong></p>");
							pw.print("<p style='color:#333333; padding-top:20px; font-size:16px; margin-bottom:3px; line-height:0.5em;'><strong>Product Price:</strong>"+"&nbsp&nbsp&nbsp&nbsp&nbsp<strong>$"+r.getPPrice()+"</strong></p><br>");
							count++;
						}
						...
						pw.print(r.getUID()+"&nbsp&nbsp&nbsp&nbsp&nbsp");
						...
						pw.print(r.getProductOnSale()+"&nbsp&nbsp&nbsp&nbsp&nbsp");
