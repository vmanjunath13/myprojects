            ...
            throws IOException, ServletException 
	{
		...
		{	
			...
			// check if user sent empty string
				if (!searchId.equals("")) 
				{
					...
					if (namesAdded) 
					{
						...
						response.getWriter().write("<providers>" + sb.toString() + "</providers>");
					} 
					else 
					{
						//nothing to show
			...
			if (action.equals("lookup"))
			{
				...
				HashMap<String,Provider> data=AjaxUtility.getData();     	
				if ((searchId != null) && data.containsKey(searchId.trim())) 
				{
					...
					RequestDispatcher rd=context.getRequestDispatcher("/ProviderData");
