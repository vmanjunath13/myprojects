...
public class DataVisualization extends HttpServlet {
    ...
    protected void displayPage(HttpServletRequest request, HttpServletResponse response, PrintWriter pw)
        ...
        pw.print("<h4><button id='btnGetChartData' style='margin-left:350px;background-color:#006666;border-radius:8px;color:#fff;height:30px;width: 100px;'>View Chart</h4>");
