...
public class Login extends HttpServlet {
	...
	protected void displayLogin(HttpServletRequest request,
		...
		pw.print("<h2 class='title meta'><a style='font-size: 36px;color:#000 !important;'>LOGIN<br><br></a></h2>"
				+ "<div class='entry'>"
				+ "<div class='post1'>");
		if (error)
		...
		pw.print("<form method='post' action='Login'>"
				...
				+ "<h3 style='color:#000 !important;'>Username</h3></td><td><input type='text' name='username' value='' class='input' required></input>"
				+ "</td></tr><tr><td>"
