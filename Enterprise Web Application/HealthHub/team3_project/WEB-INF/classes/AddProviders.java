...
@WebServlet("/AddProviders")

public class AddProviders extends HttpServlet {
	...
	protected void displayLogin(HttpServletRequest request,
		...
		pw.print("<h2 class='title meta' style='text-align:center; padding-top:20px;'><a style='font-size:32px; color:#333333; text-align:center;'>Add Provider</a></h2>"
				+ "<div class='entry'>"
				+ "<div style='width:400px; margin:25px; margin-left: auto;margin-right: auto;'>");

		pw.print("<form name ='AddProvider' action='ProviderCrud' method='get'>");
		...
		pw.print("<tr style='padding-top:10px;'><td style='text-align:right;font-size:18px;'>");
		...
		pw.print("<input type='submit' name='button' value='Add Provider' class='btnbuy' style='margin-top:20px;'>");
