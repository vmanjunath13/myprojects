...
function initMap() {
	//console.log("inside map here");
	//var latlon = eval('<%=request.getAttribute("latlon") %>');
	//console.log(lat, lon);
	// Map pr = (Map) request.getAttribute("hash");
...
function geocodeAddress(loc, map) {
	console.log(loc);
	...
	marker.info = new google.maps.InfoWindow({
		content: '<a href="Detail?ID=' + loc.id + '"><b>' + loc.name + '</b></a><p style="margin-bottom: 2px; line-height: normal;">' + loc.speciality + '</p><p style="margin-bottom: 2px; line-height: normal;">' + loc.address +  '</p>'
	});
...
function infoWindow(marker, map, name, address) {
    google.maps.event.addListener(marker, 'click', function () {
        var html = "<div><h3>" + name + "</h3><p>" + address + "<br></div></p></div>";
