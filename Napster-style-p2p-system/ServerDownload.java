...
public class GroupOneServerDownload extends Thread
{
    int peerServerPort;
    ...
    */
    GroupOneServerDownload(int peerServerPort,String directoryPath) {        
    ...
    public void run(){
    	try {
    			...
    			Logger.getLogger(GroupOneServerDownload.class.getName()).log(Level.SEVERE, null, ex);
    	}
    }    
} 
